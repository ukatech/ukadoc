...
var AllSiteSearch, AllSiteSearchClass, TinySegmenter, cheerio;
...
AllSiteSearchClass = (function() {
  ...
  AllSiteSearchClass.prototype.serialize = function() {
    var _ref;
    return {
      index: (_ref = this.index) != null ? _ref.toJSON() : void 0,
  ...
  AllSiteSearchClass.prototype.add_html = function(file, html, selector, use_fake_id) {
    ...
    contents.each(function() {
      ...
      elem = $(this);
      if (elem.is('h1, h2, h3, h4, h5, h6') && (use_fake_id || elem.attr('id'))) {
        id = elem.attr('id');
        if (id == null) {
          head_index++;
          id = "head" + head_index;
