...
var $, argv, cheerio, chrtostr, file, filepath, files, fs, html, options, path, sections, targets, word, word_link, words, words_html, xhtml, _i, _j, _len, _len1, _ref;
...
fs.writeFileSync(filepath, chrtostr(xhtml($.html())), 'utf8');
